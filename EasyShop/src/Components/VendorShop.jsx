        ...
        <section className="w-full pb-10">
            ...
            <div className="max-w-6xl mx-auto px-4 lg:px-6 -mt-12 md:-mt-16 relative z-10 mb-12">
                <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg border border-gray-100 flex flex-col md:flex-row items-center md:items-center gap-4 md:gap-6">
                    ...
                    {/* Optional: Action Button (Agar zarurat ho) */}
                    {/* <div className="hidden md:block">
                        <button className="px-6 py-2 bg-pink-500 text-white text-sm font-bold rounded-lg hover:bg-pink-600 transition-colors shadow-md shadow-pink-100">
                            Follow
                        </button>
                    </div> */}
                </div>
                    ...
                    {(products || []).map((product) => {
                        ...
                        return (
                            <div
                                ...
                                className="group cursor-pointer bg-white rounded-xl shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 overflow-hidden"
                            >
                                {/* Image Container */}
