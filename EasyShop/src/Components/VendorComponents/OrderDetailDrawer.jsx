...
function OrderDetailDrawer({ orderId, isOpen, onClose }) {
    ...
    return (
        ...
        >
            <div
                onClick={(e) => e.stopPropagation()} // Drawer ke andar click karne par band nahi hoga
            ...
            >
                ...
                <div className="p-6 space-y-8">
                    ...
                    {/* 2. Customer & Shipping (Added a small fix for contact) */}
                    <section className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-2xl bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100/50">
                            <div className="flex items-center gap-2 mb-2 text-blue-600">
                                <FiMapPin size={14} />
                                <span className="text-[11px] font-black uppercase">Shipping To</span>
                            </div>
                    ...
                    {/* 3. Tracking Timeline (Extra Professional Touch) */}
                    {order.trackingHistory && (
                        <section>
                            <h3 className="text-xs font-bold text-slate-400 uppercase mb-4 flex items-center gap-2">
                                <FiClock className="text-blue-500" /> Order Timeline
                            </h3>
                            <div className="space-y-4 ml-2 border-l-2 border-slate-100 dark:border-slate-800 pl-4">
                                {order.trackingHistory.map((track, i) => (
                                    <div key={i} className="relative">
                                        ...
                                        <p className="text-xs font-bold text-slate-700 dark:text-slate-300">{track.status}</p>
