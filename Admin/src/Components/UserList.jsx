...
function UserList() {
    ...
    if (isLoading) return <p className="p-10 text-center">{t('adminUsers.loading')}</p>;
    if (isError) return <p className="p-10 text-center text-red-500">{t('adminUsers.error')}</p>;
                ...
                <table className="w-full text-left">
                    ...
                    <thead className="bg-slate-50/50 dark:bg-slate-800/50">
                        <tr className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                            <th className="px-6 py-4">{t('adminUsers.colUserDetails')}</th>
                            <th className="px-6 py-4 text-center">{t('adminUsers.colEngagement')}</th>
                            <th className="px-6 py-4">{t('adminUsers.colJoinedDate')}</th>
                            <th className="px-6 py-4 text-center">S{t('adminUsers.colStatus')}</th>
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        ...
                                        >
                                            ...
                                            {isThisRowLoading ? (
                                                ...
                                                user.isActive ? t('adminUsers.activeStatus') : t('adminUsers.inactiveStatus')
                                            )}
                                        </button>
                                    </td>
